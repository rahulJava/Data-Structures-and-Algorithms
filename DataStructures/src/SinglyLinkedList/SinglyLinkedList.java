...
public class SinglyLinkedList
{
	...
	public static void removeDuplicates1(SinglyLinkedList list1)
	{
		...
		while(curr.next!=null)
		{
			...
			next1=curr.next;
			System.out.println("next data:"+next1.data);
			...
			else
			{
				...
				System.out.println("curr.next prev"+curr.data);
				curr=curr.next;
	...
	public static void hash(SinglyLinkedList List2)
	{
		Node n1 = List2.first;
		Hashtable<Node , Integer > has= new Hashtable<>();
		while(n1!=null)
		{
			has.put(n1, n1.data);
			n1 = n1.next;
		}
		System.out.println("printing hashtable"+has.get(List2.first.next.next.next));
